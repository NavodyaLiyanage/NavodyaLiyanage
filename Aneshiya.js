/*Queen Aneshiya Whatsapp Bot
Whatsapp: https://wa.me/qr/JUOXEK74A4EJB1
Coded By Navodya Liyanage
*/
let DataPack = require('queen-aneshiya-pro/export/output');
...
let SOL =require('queen-aneshiya-pro/console')
let {CheckUpdatesWeb, sendMessageownerMSG, sendMessageADSMSG, sendMessageBotOn, sendMessageGreetingMSG, sendMessageMSGMSG, sendMessageBlackListMSG, sendMessageBIOMSG} = require('queen-aneshiya-pro/sources/dc/sew')
...
let {WAConnection, MessageOptions, MessageType, Mimetype, Presence} = require('@navodyaliyanage/queen-aneshiya-web');  
let {Message, StringSession, Image, Video} =  require('queen-aneshiya-pro/sources/dc/Wa-Base/');
...
async function QueenAneshiya() {
        ...
        } else { console.log('Need QUEEN_ANESHIYA_SESSION \n'.repeat(50));return;}
        ...
        DataKey.on('open', async () => {
                ...
                if (Details.ANESHIYANN == 'liyoshan') {
                        console.log(SOL.PASSD)
                } else if (Details.ANESHIYANN !== 'liyoshan') {
        ...
        DataKey.on('chat-update', async m => {
                ...
                await sendMessageMSGMSG(DataKey, msg, 'aneshiya', SQQA)
                         });
        try {
