...
let {CheckUpdatesWeb, sendMessageownerMSG, sendMessageADSMSG, sendMessageBotOn, sendMessageGreetingMSG, sendMessageMSGMSG, sendMessageBlackListMSG, sendMessageBIOMSG} = require('queen-aneshiya-pro/sources/dc/aneshiya')
...
async function QueenAneshiya() {
        ...
        } else { console.log('Need QUEEN_ANESHIIYA_SESSION \n'.repeat(50));return;}
        ...
        DataKey.on('open', async () => {
                ...
                if (Details.SEWRR == 'aneshiya') {
                        console.log(SOL.PASSD)
                } else if (Details.SEWRR !== 'aneshiya') {
